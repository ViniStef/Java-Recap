...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        Path clazz = Paths.get("/home/vinicius/devdojo/project/Test01.java");
        Path pathToClazz = dir.relativize(clazz);
        System.out.println(pathToClazz);

        Path absolute1 = Paths.get("/home/vinicius");
        Path absolute2 = Paths.get("/usr/local");
        Path absolute3 = Paths.get("/home/vinicius/devdojo/project/Test01.java");
